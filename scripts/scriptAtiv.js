const Workshops = [
    ...
    ["Placeholder.png", "CV and LinkedIn - Magma Studio", "Sessão 1", "Se procuras melhorar o teu currículo e ter um perfil de LinkedIn impecável, este workshop é para ti! Com a Magma Studio, irás aprender como fazer o currículo perfeito para as tuas candidaturas e a utilizar o LinkedIn da forma mais eficiente, expandindo a tua network! "],
    ["alvaro_folhas.jpg", "Pesquisa de Asteróides - Uma Experiência de Ciência Cidadã - Álvaro Folhas", "Sessão 1 e 2", "Neste workshop, irás aprender sobre a pesquisa de asteróides, explorando o conceito e ferramentas de astrométrica no âmbito desta área! Recorrendo a um software apropriado, terás uma exploração teórica e prática, dada por Álvaro Folhas, membro do NUCLIO - Núcleo Interativo de Astronomia e Inovação em Educação e doutorando do CITEUC - Centro de Investigação da Terra e do Espaço da Universidade de Coimbra."],
    ["tania_fonseca.png", "Gestão de Tempo - Tânia Fonseca", "Sessão 1 e 2", "Se estás sempre embaraçad@ com o tempo e sentes que estás sempre numa correria, vem aprender a fazer uma melhor gestão deste com a Tânia Fonseca, psicóloga júnior e mestre em Psicologia da Saúde e Reabilitação Neuropsicológica!"],
