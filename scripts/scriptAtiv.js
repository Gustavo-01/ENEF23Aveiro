const Workshops = [
    ...
    ["Luis_Silva.jpg", "Fundamentos de Machine Learning - Luís Silva", "Sessão 1 e 2", "Neste Workshop, terás a oportunidade de aprender sobre como funciona o Machine Learning, um dos sub-campos da computação mais relevantes na atualidade, nomeadamente importante para o desenvolvimento de Inteligência Artificial!<br/><p style='font-weight:bold;margin-bottom:0'>Vagas:15</p>"],
    ["nuno_silva.jpg", "Criptografia num Mundo Pós-Quântico - Nuno Silva", "Sessão 1 e 2", " A criptografia e a computação quântica são peças fundamentais nas redes de comunicações atuais. Neste Workshop, terás a oportunidade de trabalhar com algoritmos quânticos, usando o QISKIT, e trabalhar com a criptografia quântica como solução para o surgimento de um computador quântico.<br/><p style='font-weight:bold;margin-bottom:0'>Vagas:15</p>"],
    ["Placeholder.png", "CV and LinkedIn - Magma Studio", "Sessão 1", "Se procuras melhorar o teu currículo e ter um perfil de LinkedIn impecável, este workshop é para ti! Com a Magma Studio, irás aprender como fazer o currículo perfeito para as tuas candidaturas e a utilizar o LinkedIn da forma mais eficiente, expandindo a tua network!<br/><p style='font-weight:bold;margin-bottom:0'>Vagas:24</p>"],
    ...
    ["tania_fonseca.png", "Gestão de Tempo - Tânia Fonseca", "Sessão 1 e 2", "Se estás sempre embaraçad@ com o tempo e sentes que estás sempre numa correria, vem aprender a fazer uma melhor gestão deste com a Tânia Fonseca, psicóloga júnior e mestre em Psicologia da Saúde e Reabilitação Neuropsicológica!<br/><p style='font-weight:bold;margin-bottom:0'>Vagas:24</p>"],
    ["david_furtado.jpg", "Impressão 3D - David Furtado", "Sessão 1", "Este Workshop destina-se aos interessados em aprender acerca de impressão 3D. Neste Workshop terás a oportunidade de aprender técnicas de modelação e o processo por trás de como funciona uma impressora 3D e como fazeres as tuas próprias impressões!<br/><p style='font-weight:bold;margin-bottom:0'>Vagas:8</p>"],
